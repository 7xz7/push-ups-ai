...
class MainActivity : AppCompatActivity() , TextToSpeech.OnInitListener{
    ...
    private var  textToSpeech: TextToSpeech? = null // textToSpeech = TextToSpeech(this, this)
            ...
            if (cameraSource == null) {
                cameraSource =
                    CameraSource(surfaceView, object : CameraSource.CameraSourceListener {
                        ...
                        override fun onTTS(spechText:String) {
                            textToSpeech?.speak(spechText, TextToSpeech.QUEUE_FLUSH, null, null)
                        }
